                    ...
                    <table class="table" cellspacing="0">
                        ...
                        @foreach ($cartDetails as $detail)
                            <tr>
                                ...
                                <td class="text-center fw-bold">{{ number_format($detail->product->price),0, ',', '.'}}</td>
                                <td class="text-center fw-bold">{{number_format($detail->product->price* $detail->quantity) ,0, ',', '.'  }}</td>
