        ...
        <div class="pagetitle">
            ...
            <div class="col-lg-12">
                <div class="card card-table">
                    ...
                    <div class="card-body">
                        <table id="category_table" data-page-length='3'
                            ...
                            <span class="custom-checkbox">
                                ...
                                <label for="checkbox1"></label>
                                    ...
                                    <td class="d-flex justify-content-around align-content-center">
                                        <a href="{{route('admin.edit-category',['id'=>$category->id])}}" ><i class="material-icons"></i></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                @if(isset($category) && $category)
                    <form action="/home/brand/{{$category-> id}}" method="POST">
                        @method('DELETE')
                        @csrf
                        <div class="modal-header">
