                    ...
                    <div class="col-lg-12">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="price" id="productPriceLabel" value="{{$product->price}}">
                                        </div>
                                    </div>
                                </div>
                                <!-- End Row -->
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <input id="" type="text" name="description"  class="form-control" required="" value="{{$product -> description}}" >
                                    </div>
                                </div>
                        ...
                        <div class="card mb-3 mb-lg-5">
                            ...
                            <div class="card-body">
                                ...
                                <div id="attachFilesNewProjectLabel" class="js-dropzone dropzone-custom custom-file-boxed">
                                    <label for="new_images">Ảnh mới</label>
                                    <input type="file" class="form-control-file" id="new_images" name="new_images[]" multiple>
                                </div>
                                <!-- End Dropzone -->
                            </div>
                            <!-- Body -->
